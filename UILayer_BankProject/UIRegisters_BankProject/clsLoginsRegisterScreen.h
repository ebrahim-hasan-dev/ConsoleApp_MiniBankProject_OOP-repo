...
private:
	...
	static void _PrintLoginsRegister(clsUser::stLoginsAndLogOutsRegister& User)
	{
...
public:
	...
	static void PrintLoginsRegisterList()
	{
		system("cls");

		vector <clsUser::stLoginsAndLogOutsRegister> vUsers = clsUser::GetAllLoginsRegister();
		...
		if (vUsers.size() == 0)
		{
			cout << "\n\n\n\n\t\t\tNo Logins Resiter Available In The System!\n\n";
		}
		else
		{
			_PrintHeaderTaple();
